...
public class MascotaAdapterDetalle extends RecyclerView.Adapter<MascotaAdapterDetalle.MascotaViewHolder>{

    ArrayList<Mascota> mascotas;
    Activity activity;

    public MascotaAdapterDetalle(ArrayList<Mascota> mascotas, Activity activity ) {
    ...
    public MascotaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_detalle_mascota,parent,false);
